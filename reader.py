...
import os
import json
from PySide6.QtWidgets import QWidget, QVBoxLayout, QGraphicsView, QGraphicsScene, QGraphicsPixmapItem, QApplication, QComboBox, QHBoxLayout, QLabel, QPushButton
