...
class SegDetectorRepresenter():
    ...
    def __call__(self, batch, pred, is_output_polygon=False, height=None, width=None):
        ...
        '''
        # If pred is (N, C, H, W) take channel 0
        if len(pred.shape) == 4:
            pred = pred[:, 0, :, :]
    ...
    def polygons_from_bitmap(self, pred, _bitmap, dest_width, dest_height):
        ...
        if isinstance(_bitmap, torch.Tensor):
    ...
    def boxes_from_bitmap(self, pred, _bitmap, dest_width, dest_height):
        ...
        for index in range(num_contours):
            ...
            # The original code commented this out, but it seems correct to filter by score
            # if self.box_thresh > score:
            #     continue
    ...
    def box_score_fast(self, bitmap, _box):
        ...
        # Ensure bitmap is float32 for cv2.mean
